...
const u8 CustomHID_DeviceDescriptor[CUSTOMHID_SIZ_DEVICE_DESC] =
  {
    ...
    0x1A,                       /*idVendor (0x051A)*/
    0x05,
    0x1B,                       /*idProduct = 0x511B*/
    0x51,
...
//    0x96,         /* MaxPower 300 mA: this current is used for detecting Vbus */
    ...
    SendLength/256,
    0x0A,          /*0X20 bInterval: Polling Interval (21 ms) */
    /* 34 */
    ...
    0x0A,	/* 0X10 bInterval: Polling Interval (32 ms) */
    /* 41 */
  }
...
const u8 CustomHID_StringVendor[CUSTOMHID_SIZ_STRING_VENDOR] =
  {
    ...
    'M', 0, 'I', 0, 'S', 0,'R', 0,'O', 0, 'B', 0, 'O', 0,'T',0,
  };
...
const u8 CustomHID_StringProduct[CUSTOMHID_SIZ_STRING_PRODUCT] =
  {
    ...
    USB_STRING_DESCRIPTOR_TYPE,        /* bDescriptorType */
    'P', 0,'U', 0, 'N', 0, 'C', 0,'T',0,'U',0,'R',0,'E',0,
  };
const u8 CustomHID_StringSerial[CUSTOMHID_SIZ_STRING_SERIAL] =
  {
    CUSTOMHID_SIZ_STRING_SERIAL,           /* bLength */
    USB_STRING_DESCRIPTOR_TYPE,        /* bDescriptorType */
    '2', 0,'0', 0, '1', 0, '4', 0,'0',0,'7',0,'1',0,'1',0,
  };
